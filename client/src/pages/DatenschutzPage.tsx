  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-container">
        ...
        <section className="legal-section">
          <h2>Conversion-Messung (Google Ads)</h2>
          <p>
            Wenn Sie über eine Google-Werbeanzeige auf unsere Website gelangen, wird ein sogenannter gclid-Parameter in der URL übertragen. Dieser Parameter wird ausschließlich im Arbeitsspeicher Ihres Browsers gespeichert (kein Cookie, kein localStorage, keine dauerhafte Speicherung auf Ihrem Gerät). Der Parameter wird beim Schließen des Browser-Tabs automatisch gelöscht.
          </p>
          <p>
