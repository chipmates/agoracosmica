    ...
    <div className="legal-page">
      ...
      <div className="legal-container">
        ...
        <section className="legal-section">
          ...
          <p>
            Mit Ihrer Einwilligung übermitteln wir den gclid bei bestimmten Ereignissen (Profilerstellung, Auswahl eines Lernmodus, Nutzung eines Konzils) serverseitig über die Google Ads Conversion API, damit die Anzeige einer Conversion zugeordnet werden kann (kein JavaScript-Tracker, kein Pixel auf der Website). Übermittelt werden: der gclid, das ausgelöste Ereignis, gegebenenfalls die gewählte Persönlichkeit, Ihr Länder-Kürzel, ein interner Wert und ein Zeitstempel. Gesprächsinhalte und sonstige personenbezogene Daten werden nicht übermittelt. Auf unseren Systemen speichern wir den gclid nicht dauerhaft.
          </p>
          <p>
