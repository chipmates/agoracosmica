...
['austen','jane-austen','Jane Austen','Jane Austen','Literary Realism','Literarischer Realismus',
 ...
 'How do I tell what someone means when their words say something else?',
 'Woran erkenne ich, was jemand meint, wenn die Worte anderes sagen?'],
...
['bingen','hildegard-von-bingen','Hildegard von Bingen','Hildegard von Bingen','Christian Mysticism','Christliche Mystik',
 ...
 'I walk through my days without seeing any of it. Where do I start?',
 'Ich gehe durch meine Tage, ohne etwas davon zu sehen. Wo fange ich an?'],
['campbell','joseph-campbell','Joseph Campbell','Joseph Campbell','Comparative Mythology','Vergleichende Mythologie',
 ...
 'Ich stecke mitten in einer großen Veränderung. Wie heißt dieser Teil?'],
['zenji','dogen-zenji','Dōgen Zenji','Dōgen Zenji','Zen Buddhism','Zen-Buddhismus',
 ...
 'I am never where I am. How do I stop running ahead?',
 'Ich bin nie da, wo ich bin. Wie höre ich auf, vorauszulaufen?'],
...
['einstein','albert-einstein','Albert Einstein','Albert Einstein','Theoretical Physics','Theoretische Physik',
 'You will learn to keep asking why.','Du lernst, weiter nach dem Warum zu fragen.',
 'How do you keep a question open when everyone wants the answer now?',
 'Wie hältst du eine Frage offen, wenn alle sofort die Antwort wollen?'],
['eckhart','meister-eckhart','Meister Eckhart','Meister Eckhart','Christian Mysticism','Christliche Mystik',
 'You will learn to stop clutching what you love.','Du lernst, zu lieben, ohne zu klammern.',
 'I hold on too tight to the people I love. How do I loosen it?',
 'Ich halte die Menschen, die ich liebe, zu fest. Wie lockere ich das?'],
...
['goethe','johann-wolfgang-von-goethe','Johann Wolfgang von Goethe','Johann Wolfgang von Goethe','German Classicism','Weimarer Klassik',
 'You will learn to look until you understand.','Du lernst, so lange hinzusehen, bis du verstehst.',
...
['gautama','siddhartha-gautama','Siddhartha Gautama','Siddhartha Gautama','Buddhism','Buddhismus',
 ...
 'I get what I wanted and want the next thing by evening. Why?',
 'Ich bekomme, was ich wollte, und will am Abend das Nächste. Warum?'],
...
['king','martin-luther-king-jr','Martin Luther King Jr.','Martin Luther King Jr.','Civil Rights and Theology','Bürgerrechte und Theologie',
 'You will learn to resist without hate.','Du lernst, Widerstand zu leisten, ohne zu hassen.',
 'How do I fight something without becoming bitter?',
 'Wie kämpfe ich gegen etwas, ohne bitter zu werden?'],
['lovelace','ada-lovelace','Ada Lovelace','Ada Lovelace','Mathematics and Computing','Mathematik und Computing',
 'You will learn to see what a thing could become.','Du lernst, zu sehen, was etwas werden könnte.',
 'How do you see what a machine could become before anyone else does?',
 'Wie siehst du, was eine Maschine werden kann, bevor andere es sehen?'],
...
['mozart','wolfgang-amadeus-mozart','Wolfgang Amadeus Mozart','Wolfgang Amadeus Mozart','Classical Music','Klassische Musik',
 ...
 'The rules of my craft feel like a cage. Are they?',
 'Die Regeln meines Fachs fühlen sich wie ein Käfig an. Sind sie das?'],
['blake','william-blake','William Blake','William Blake','Visionary Poetry','Visionäre Poesie',
 'You will learn to see the chains you forged.','Du lernst, die Ketten zu sehen, die du geschmiedet hast.',
 'Which of my limits did I actually build myself?',
 'Welche meiner Grenzen habe ich selbst gebaut?'],
...
['schopenhauer','arthur-schopenhauer','Arthur Schopenhauer','Arthur Schopenhauer','Philosophy of Will','Willensphilosophie',
 'You will learn to see through the wanting.','Du lernst, das Wollen zu durchschauen.',
...
['shakespeare','william-shakespeare','William Shakespeare','William Shakespeare','Renaissance Drama','Renaissance-Drama',
 'You will learn to see a person from inside.','Du lernst, einen Menschen von innen zu sehen.',
 'How do I understand someone I find impossible?',
 'Wie verstehe ich jemanden, den ich unmöglich finde?'],
['woolf','virginia-woolf','Virginia Woolf','Virginia Woolf','Modernist Literature','Modernistische Literatur',
 'You will learn to wake inside an ordinary moment.','Du lernst, in einem gewöhnlichen Augenblick aufzuwachen.',
 'My days blur into each other. How do I wake up inside one?',
 'Meine Tage verschwimmen ineinander. Wie wache ich in einem auf?'],
...
['vinci','leonardo-da-vinci','Leonardo da Vinci','Leonardo da Vinci','Renaissance Polymath','Renaissance-Universalgelehrter',
 'You will learn to train your own eye.','Du lernst, dein eigenes Auge zu schulen.',
 'How do I learn to really see something instead of glancing at it?',
 'Wie lerne ich, etwas wirklich zu sehen, statt nur hinzuschauen?']
];
...
function paint(id) {
  ...
  askEl.href = '/app?figure=' + f.slug + '&lang=' + LANG + '&ask=hero';
