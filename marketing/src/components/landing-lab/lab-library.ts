...
export interface LibMode {
  ...
  step?: string;      // arc position marker, e.g. "Step 2" (arc modes only)
  /** Funnel door label sent in the cta_click beacon's mode slot. Set on modes
   *  whose link enters the app, so we can tell which door was used. */
  door?: string;
...
const TX: Record<'en' | 'de', Record<string, ModeText>> = {
  en: {
    story: { step: 'Step 1', tab: 'Story', glyph: 'Learn by story', kicker: 'A teaching, told as a story', title: 'The Stoic Path', body: 'The cypress trees were better than the painting.', playLabel: 'Play Chapter 1', scale: 'the first of twelve chapters', disclosure: "Each chapter turns one of his ideas into a scene you move through. Read in his AI Echo's voice. An interpretation, not a recording.", linkLabel: 'Open his full page' },
    wisdom: { step: 'Step 2', tab: 'Wisdom', glyph: 'Study an idea', kicker: 'One of his twelve core teachings', title: 'Preferred Indifferents', body: 'Health, family, success, worth wanting and worth working for. And still not what decides whether you live well.', scale: 'one of 360 core teachings', linkLabel: 'Study this with him' },
    prism: { step: 'Step 3', tab: 'Prism', glyph: 'Hear a dialogue', kicker: 'A four-voice dialogue between Echoes', title: 'The Stoic Path', body: 'During the plague years along the Danube, I watched men die faster than we could burn the dead.', duration: 'The opening exchange', playLabel: 'Play the opening', scale: 'one of 360 prism dialogues', disclosure: 'Four AI Echoes in dialogue. Interpretations, not recordings.', linkLabel: 'Hear the full dialogue' },
    quest: { step: 'Step 4', tab: 'Quest', glyph: 'Test yourself', kicker: 'A short Socratic challenge', title: 'Four questions, going deeper', body: 'His Echo asks you four questions about one of his ideas, each going deeper than the last. It measures what you understand, not what you can recite.', linkLabel: 'Take the quest' },
  ...
  de: {
    story: { step: 'Schritt 1', tab: 'Story', glyph: 'Mit Geschichten lernen', kicker: 'Eine Lehre, als Geschichte erzählt', title: 'Der stoische Weg', body: 'Die Zypressen waren besser als das Gemälde.', playLabel: 'Kapitel 1 abspielen', scale: 'das erste von zwölf Kapiteln', disclosure: 'Jedes Kapitel macht aus einer seiner Ideen eine Szene, durch die du dich bewegst. Gelesen in seiner KI-Echo-Stimme. Eine Deutung, keine Aufnahme.', linkLabel: 'Seine ganze Seite öffnen' },
    wisdom: { step: 'Schritt 2', tab: 'Weisheit', glyph: 'Eine Idee vertiefen', kicker: 'Eine seiner zwölf Kernlehren', title: 'Bevorzugte Indifferente', body: 'Gesundheit, Familie, Erfolg. Erstrebenswert und die Mühe wert. Und trotzdem nicht das, was entscheidet, ob du gut lebst.', scale: 'eine von 360 Kernlehren', linkLabel: 'Das mit ihm vertiefen' },
    prism: { step: 'Schritt 3', tab: 'Prisma', glyph: 'Einen Dialog hören', kicker: 'Ein vierstimmiger Dialog zwischen Echos', title: 'Der stoische Weg', body: 'Während der Pestjahre an der Donau sah ich Männer schneller sterben, als wir die Toten verbrennen konnten.', duration: 'Der erste Wortwechsel', playLabel: 'Den Anfang abspielen', scale: 'einer von 360 Prisma-Dialogen', disclosure: 'Vier KI-Echos im Dialog. Deutungen, keine Aufnahmen.', linkLabel: 'Den ganzen Dialog hören' },
    quest: { step: 'Schritt 4', tab: 'Quest', glyph: 'Dich selbst prüfen', kicker: 'Eine kurze sokratische Herausforderung', title: 'Vier Fragen, immer tiefer', body: 'Sein Echo stellt dir vier Fragen zu einer seiner Ideen, jede tiefer als die vorige. Es zählt, was du verstehst, nicht, was du auswendig aufsagen kannst.', linkLabel: 'Die Quest starten' },
