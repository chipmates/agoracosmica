...
import {
  decodeGrey, heatMap, nextFrames, pngSize, reader, regions, saveFrames, screencast, SD_LEVELS, temporalSd,
  tileMap, TILE,
} from './flicker-frames.mjs'
...
/* ---- PNG, ffmpeg, the capture and the arithmetic over the frames --------
   All of it lives in `flicker-frames.mjs`, so the walking eye beside this
   one reads a frame exactly the way the gate does.                        */
