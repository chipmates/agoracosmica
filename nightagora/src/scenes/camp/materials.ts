...
export function palette(): Palette {
  ...
  cached = {
    timber: inkMaterial({ surface: 'wood', rim: 0.36, albedo: '#8A7358', baseK: 0.46 }),
    timberI: inkMaterial({ surface: 'wood', rim: 0.36, albedo: '#8A7358', baseK: 0.46, instanced: true }),
    ...
    stakes: inkMaterial({ surface: 'wood', rim: 0.5, albedo: '#9A8161', baseK: 0.5, instanced: true }),
    canvas: inkMaterial({ surface: 'canvas',
      rim: 0.86,
      albedo: '#B49C7C',
      baseD: '#22243C',
      baseK: 0.34,
    ...
    ochre: inkMaterial({ surface: 'leather',
      rim: 0.66, albedo: '#8E3B22', baseD: '#2A2033', baseK: 0.46, ambK: 0.042,
      emberK: 0.07, side: DoubleSide,
    }),
    gilt: inkMaterial({ surface: 'metal', rim: 0.85, albedo: '#E6BC5C', baseK: 0.46, facePow: 2.6 }),
    aquila: inkMaterial({ surface: 'metal', rim: 0.32, albedo: '#C6A263', baseK: 0.46, facePow: 3.0 }),
    bronze: inkMaterial({ surface: 'metal', rim: 1.05, albedo: '#C08A49', baseK: 0.5, side: DoubleSide }),
    coal: inkMaterial({ rim: 1.5, albedo: '#E0762C', baseK: 0.44, facePow: 1.0 }),
    log: inkMaterial({ surface: 'wood', rim: 1.25, albedo: '#B07340', baseK: 0.46 }),
    hearthStone: inkMaterial({ rim: 0.95, albedo: '#9F8F79', baseK: 0.48, instanced: true }),
    bedroll: inkMaterial({ surface: 'canvas', rim: 0.8, albedo: '#8E6E52', baseK: 0.5 }),
    tripod: inkMaterial({ surface: 'metal', rim: 0.7, albedo: '#7E6A52', baseK: 0.5, side: DoubleSide }),
    pot: inkMaterial({ surface: 'metal', rim: 1.1, albedo: '#6E6A66', baseK: 0.46 }),
    hide: inkMaterial({ surface: 'leather', rim: 0.44, albedo: '#6B5240', baseK: 0.5 }),
    cloth: inkMaterial({ surface: 'canvas', rim: 0.34, albedo: '#6E6152', baseK: 0.52, side: DoubleSide }),
    helm: inkMaterial({ surface: 'metal', rim: 1.1, albedo: '#8C8478', baseK: 0.48 }),
    load: inkMaterial({ surface: 'leather', rim: 0.4, albedo: '#9A8A6E', baseK: 0.5 }),
    raven: inkMaterial({ rim: 0.55, albedo: '#4A4A56', baseK: 0.35 }),
    post: inkMaterial({ surface: 'wood', rim: 0.95, albedo: '#A98B62', baseK: 0.48 }),
    carve: inkMaterial({ surface: 'wood', rim: 1.6, albedo: '#CBB183', baseK: 0.5, facePow: 1.1 }),
    // the only lantern on the planet (Hearth law)
    praetorium: inkMaterial({ surface: 'canvas',
      rim: 0.5,
      albedo: '#CDBA9A',
      baseD: '#282A40',
      baseK: 0.5,
    ...
    flap: inkMaterial({ surface: 'canvas',
      rim: 0.34, albedo: '#9C8B70', baseD: '#22243A', baseK: 0.42, ambK: 0.05, side: DoubleSide,
    }),
    floor: inkMaterial({ surface: 'wood', rim: 0.62, albedo: '#8C7A5E', baseK: 0.34, facePow: 1.5 }),
    parchment: inkMaterial({ surface: 'paper', rim: 0.34, albedo: '#D8C9A4', baseD: '#2E2F42', baseK: 0.5, facePow: 1.2 }),
    lamp: inkMaterial({ rim: 0.3, albedo: '#B08A5C', baseK: 0.5 }),
    rug: inkMaterial({ surface: 'canvas',
      rim: 0.16,
      albedo: `#${OCHRE.clone().lerp(lin('#6E5A44'), 0.72).getHexString()}`,
      baseK: 0.4,
      facePow: 1.6,
    }),
    cloak: inkMaterial({ surface: 'canvas',
      rim: 0.2,
      albedo: `#${OCHRE.clone().lerp(lin('#3E3227'), 0.66).getHexString()}`,
      baseK: 0.5,
      side: DoubleSide,
    }),
    cuirass: inkMaterial({ surface: 'metal',
      rim: 0.24,
