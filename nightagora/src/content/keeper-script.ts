...
export const TYPED_REPLY: string[] = [
  'The fire keeps no answers. In the library an Echo of each of them answers, behind the door you find at every station.',
...
const FIRE_SCRIPTS: Record<Lang, KeeperScript> = {
  ...
  de: {
    ...
    offered: [],
    typedReply: [
      'Das Feuer hat keine Antworten. In der Bibliothek antwortet ein Echo von jedem von ihnen, hinter der Tür, die du an jeder Station findest.',
