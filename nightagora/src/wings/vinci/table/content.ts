...
export const TABLE_UI = {
  en: {
    ...
    unavailable: 'The transcription is not shown here.', frenchUnavailable: 'French translation not aligned',
    ...
    famous: 'Eight studies in manuscript B', shelfIntro: 'Eight studies in Paris manuscript B',
    shelfSource: 'Names and descriptions follow the verified local collection catalogue.',
    codices: 'The codices', codicesIntro: 'By holder and class',
    onTable: 'On the table', inCollection: 'Recorded in the collection', recorded: 'Recorded',
    tierOne: 'Tier 1', tierTwo: 'Tier 2', absent: 'Not on display',
  ...
  de: {
    ...
    unavailable: 'Die Umschrift wird hier nicht gezeigt.', frenchUnavailable: 'Französische Übersetzung nicht zugeordnet',
    ...
    famous: 'Acht Studien im Manuskript B', shelfIntro: 'Acht Studien im Pariser Manuskript B',
    shelfSource: 'Namen und Beschreibungen folgen dem geprüften lokalen Sammlungskatalog.',
    codices: 'Die Kodizes', codicesIntro: 'Nach Sammlung und Einstufung',
    onTable: 'Auf dem Tisch', inCollection: 'In der Sammlung verzeichnet', recorded: 'Verzeichnet',
    tierOne: 'Stufe 1', tierTwo: 'Stufe 2', absent: 'Nicht ausgestellt',
