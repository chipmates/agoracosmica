...
export const TABLE_UI = {
  en: {
    ...
    codices: 'The codices', codicesIntro: 'What this table admits, by holder and class',
  ...
  de: {
    ...
    codices: 'Die Kodizes', codicesIntro: 'Was dieser Tisch zulässt, nach Sammlung und Einstufung',
