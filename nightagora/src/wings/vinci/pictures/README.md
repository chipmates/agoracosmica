...
|---|---|
| Mona Lisa | The C2RMF colour capture (Tier 2, a per-work owner decision) hangs within the locked 79.4×53.4 cm field; signature centre stays 1.55 m. The historical printed reproduction it was chosen over stays in the record as evidence. Neither authenticates the original panel edges. |
