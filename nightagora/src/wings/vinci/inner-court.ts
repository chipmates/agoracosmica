...
export const courtDressingProvenance={
  ...
  recipe:'Seed 171019. Sparse bedded river pebbles, 0.016–0.061 m, round-shaded and sunk at their foot, concentrated toward court edges. Two shallow cart-wear traces 1.40 m apart with 0.08–0.14 m width. A proposed 0.08 m drainage seam leads from the lower stair toward the existing court centre. Stone tread wear varies within 0.008 m; continuous procedural quarry mottle, millimetre tooth and distance-filtered grain. No photographic texture or claim of surviving period wear.',
  label:{
    en:'Conjectural court finish. The court is paved with river cobbles about 40 to 65 mm across, set in sand. They are mossy toward the wall feet and worn flatter along the way from the gate to the door. A kerb of long stones divides them from the walk before the house, paved with pale limestone slabs about 0.9 by 0.6 m. Cobbles, kerb and slabs are types of the period. Loose pebbles of 16 to 61 mm, cart traces and the narrow drainage seam are museum dressing, not surviving evidence of 1517. The cart traces are 1.40 m apart and the drainage seam is 0.08 m wide. The worn hollow in the stone treads stays within 0.008 m.',
    de:'Vermutete Hofoberfläche. Der Hof ist mit Flusskieseln von etwa 40 bis 65 mm gepflastert, in Sand gesetzt. Zu den Mauerfüßen hin sind sie bemoost, entlang des Wegs vom Tor zur Tür flacher getreten. Ein Bordstein aus langen Steinen trennt sie vom Weg vor dem Haus, der mit hellen Kalksteinplatten von etwa 0,9 mal 0,6 m belegt ist. Pflaster, Bordstein und Platten sind Typen der Zeit. Lose Kiesel von 16 bis 61 mm, Wagenspuren und die schmale Entwässerungsfuge sind museale Ausgestaltung, keine erhaltenen Belege von 1517. Die Wagenspuren liegen 1,40 m auseinander, die Entwässerungsfuge ist 0,08 m breit. Die ausgetretene Mulde in den Steinstufen bleibt innerhalb von 0,008 m.',
  },
} as const
