      ...
      for (let fork = 0; fork < forks; fork++) {
        ...
        for (let twig = 0; twig < twigs; twig++) {
          ...
          for (let i = 0; i < count; i++) {
            ...
            // A TWIG CARRIES A SLEEVE, NOT A BALL. The same leaves sprayed
            // through a narrower volume cover it: coverage rises with the
            // square of the radius the spray comes down by.
