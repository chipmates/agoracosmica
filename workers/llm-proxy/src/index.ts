...
function getCorsHeaders(request: Request, env: Env): Record<string, string> {
  ...
  return {
    ...
    'Access-Control-Expose-Headers': 'X-Quota-Daily-Used, X-Quota-Daily-Limit, X-Quota-Resets-At, X-Council-Daily-Used, X-Council-Daily-Limit, X-Council-Resets-At, X-Summary-Daily-Used, X-Summary-Daily-Limit, X-Summary-Resets-At, X-AI-Generated, X-AI-Model, X-AI-Provider, X-Model',
